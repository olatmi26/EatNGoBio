      ...
      >
        <div className="flex items-center gap-3 mb-4">
          <div
            ...
            style={{ background: danger ? '#fef2f2' : '#f0fdf4' }}
          >
        ...
        <div className="flex gap-3 justify-end">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm rounded-lg cursor-pointer whitespace-nowrap font-medium transition-colors"
          ...
          <button
            ...
            className="px-4 py-2 text-sm rounded-lg cursor-pointer whitespace-nowrap font-medium text-white transition-colors"
            style={{ background: danger ? '#dc2626' : '#16a34a' }}
          >
            {confirmLabel}
          </button>
        </div>
