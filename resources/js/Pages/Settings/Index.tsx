...
export default function SettingsPage({
    ...
    const inputClass =
        "w-full px-3 py-2 rounded-lg text-sm outline-none focus:ring-2 focus:ring-green-500/20";
    ...
    const showSaveButton = !["users", "provisioning", "security"].includes(
        activeSection,
    );
            ...
            >
                ...
                <div className="flex items-center justify-between mb-5">
                    <div>
                        ...
                        >
                            Configure system preferences and ADMS server
                        </p>
                    </div>
                    {showSaveButton && (
                        <button
                                            ...
                                            <div key={field.key}>
                                                ...
                                                {field.type === "select" ? (
                                                    <select
                                                        value={
                                                            companySettings[
                                                                field.key as keyof typeof companySettings
                                                            ] as string
                                                        }
                                                        onChange={(e) =>
                                                            setCompanySettings(
                                            ...
                                            <div key={field.key}>
                                                ...
                                                {field.type === "select" ? (
                                                    <select
                                                        value={
                                                            admsSettings[
                                                                field.key as keyof typeof admsSettings
                                                            ] as string
                                                        }
                                                        onChange={(e) =>
                                                            setAdmsSettings(
                                        ...
                                        {[
                                            ...
                                            <div key={field.key}>
                                                ...
                                                <input
                                                    ...
                                                    value={
                                                        attendanceSettings[
                                                            field.key as keyof typeof attendanceSettings
                                                        ] as string | number
                                                    }
                                                    onChange={(e) =>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        >
                                            <div>
                                                ...
                                                >
                                                    Send weekly attendance
                                                    summary every Monday
                                                </p>
                                            </div>
                                            <Toggle
                                                value={
                                                    notifSettings.weeklyReport
                                                }
                                                onChange={(v) =>
                                                    setNotifSettings((s) => ({
                                                        ...s,
