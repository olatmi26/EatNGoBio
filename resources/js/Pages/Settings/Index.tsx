...
const settingsSections = [
    ...
    { id: "locations", icon: "ri-map-pin-line", label: "Location Access" },
    {
        id: "notifications",
...
export default function SettingsPage({
    ...
    const getInitialSection = (): SectionId => {
        ...
        return settingsSections.some((s) => s.id === hash)
            ? (hash as SectionId)
            : "company";
    };
    ...
    const [admsSettings, setAdmsSettings] = useState({
        serverUrl:
            initialSettings?.adms_server_url ||
    ...
    const [notifSettings, setNotifSettings] = useState({
        ...
        consecutiveAbsenceThreshold:
            initialSettings?.notif_absence_threshold || 3,
        ...
        biometricEnrollment:
            initialSettings?.notif_biometric_enrollment ?? true,
        emailAlerts: initialSettings?.notif_email_alerts ?? true,
        alertEmail:
            initialSettings?.notif_alert_email || "admin@eatngo-africa.com",
    });
    ...
    const inputClass =
        "w-full px-3 py-2 rounded-lg text-sm outline-none focus:ring-2 focus:ring-green-500/20 transition-all";
    ...
    const handleSave = async () => {
        ...
        switch (activeSection) {
            case "company":
                settingsData = { company: companySettings };
                break;
            case "adms":
                settingsData = { adms: admsSettings };
                break;
            case "attendance":
                settingsData = { attendance: attendanceSettings };
                break;
            case "notifications":
                settingsData = { notifications: notifSettings };
                break;
            default:
                setIsSaving(false);
                return;
    ...
    const Toggle = ({
        ...
        <button
            ...
            style={{
                background: value ? "#16a34a" : isDark ? "#4b5563" : "#d1d5db",
            }}
        >
            <div
                ...
                <div className="md:hidden mb-4">
                    ...
                    >
                        <div className="flex items-center gap-2">
                            <i
                                className={`${settingsSections.find((s) => s.id === activeSection)?.icon} text-sm`}
                                style={{ color: "#16a34a" }}
                            />
                            {activeLabel}
                        </div>
                        <i
                            className={`ri-arrow-${mobileMenuOpen ? "up" : "down"}-s-line text-sm transition-transform`}
                            style={{ color: textSecondary }}
                        />
                    </button>
                    {mobileMenuOpen && (
                    ...
                    <div className="flex-1 min-w-0">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <button
                                                className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium cursor-pointer whitespace-nowrap transition-colors hover:opacity-80"
                                                style={{
                                                    background: isDark
                                                        ? "#374151"
                                                        : "#f3f4f6",
                            ...
                            <div className="space-y-5">
                                ...
                                >
                                    ...
                                    <p
                                        ...
                                        style={{ color: textSecondary }}
                                    >
                                        Configure the ZKTeco ADMS protocol
                                        server. Devices must point to this
                                        server URL and port to connect.
                                    </p>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
                                        <div className="sm:col-span-2">
                                            ...
                                            <input
                                                ...
                                                placeholder="https://engobio.coldstonecreamery.ng"
                                                className={inputClass}
                                                style={inputStyle}
                                            />
                                            <p
                                                ...
                                                style={{ color: textSecondary }}
                                            >
                                                This is the URL your IT officer
                                                configures on each physical
                                                device
                                            </p>
                                        </div>
                                        {[
                                        ...
                                        {[
                                            {
                                                ...
                                                desc: "Automatically detect new devices when they connect to the ADMS server",
                                            },
                                            {
                                                key: "requireConfirmation",
                                                label: "Require Admin Confirmation",
                                                desc: "New devices show as Pending until an admin confirms them",
                                            },
                                        ].map((item) => (
                                            <div
                                                key={item.key}
                                            ...
                                            >
                                                ...
                                                <Toggle
                                                    value={
                                                        admsSettings[
                                                            item.key as keyof typeof admsSettings
                                                        ] as boolean
                                                    }
                                                    onChange={(v) =>
                                                        setAdmsSettings(
                                    ...
                                    >
                                        ...
                                        <div className="space-y-2">
                                            {[
                                                {
                                                    method: "GET",
                                                    path: "/iclock/cdata?SN=&lt;serial&gt;&options=all",
                                                    desc: "Device registration & heartbeat",
                                                },
                                                {
                                                    method: "POST",
                                                    path: "/iclock/cdata?SN=&lt;serial&gt;&table=ATTLOG",
                                                    desc: "Push attendance records",
                                                },
                                                {
                                                    method: "GET",
                                                    path: "/iclock/getrequest?SN=&lt;serial&gt;",
                                                    desc: "Poll for pending commands",
                                                },
                                                {
                                                    method: "POST",
                                                    path: "/iclock/devicecmd?SN=&lt;serial&gt;",
                                                    desc: "Command acknowledgement",
                                                },
                                            ].map((ep) => (
                                                <div
                                                    key={ep.path}
                                        ...
                                        <div
                                            className="mt-3 pt-3"
                                            style={{
                                                borderTop: `1px solid ${isDark ? "#4b5563" : "#bbf7d0"}`,
                                            }}
                                        >
                                            <p
                                            ...
                                            >
                                                ...
                                                Instructions for IT Officer:
                                            </p>
                                            <p
                                                className="text-xs"
                                                style={{ color: textSecondary }}
                                            >
                                                On the ZKTeco device, go to{" "}
                                                <strong>
                        ...
                        {activeSection === "provisioning" && (
                            <DeviceProvisioning
                                ...
                                locations={locations}
                                admsSettings={{
                                    autoProvision: admsSettings.autoProvision,
                                    requireConfirmation:
                                        admsSettings.requireConfirmation,
                                }}
                            />
                        )}
                        ...
                        {activeSection === "locations" && (
                            <LocationAccess
                                users={
                                    userAccess.length > 0 ? userAccess : users
                                }
                                locations={locations}
                                areas={areas}
                                isDark={isDark}
                                onUpdate={() => {
                                    showToast(
                                        "success",
                                        "Access Updated",
                                        "Location access permissions have been updated",
                                    );
                                }}
                            />
                        )}
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        {[
                                            ...
                                            {
                                                label: "Minimum Work Hours (for half-day)",
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        {[
                                            {
                                                ...
                                                key: "lateThreshold",
                                                desc: "Minutes after work start time before marked as late",
                                            },
                                            {
                                        ...
                                        <div>
                                            ...
                                            <select
                                                value={
                                                    attendanceSettings.roundingInterval
                                                }
                                                onChange={(e) =>
                                                    setAttendanceSettings(
                                                        (s: any) => ({
                                    ...
                                    <div className="mt-5 space-y-3">
                                        {[
                                            {
                                                key: "countWeekends",
                                                label: "Count Weekends as Work Days",
                                                desc: "Include Saturday and Sunday in attendance calculations",
                                            },
                                            {
                                                key: "countHolidays",
                                                label: "Count Public Holidays as Work Days",
                                                desc: "Include public holidays in attendance calculations",
                                            },
                                            {
                                                key: "autoCheckout",
                                                label: "Auto Checkout at End of Day",
                                                desc: `Automatically check out employees at ${attendanceSettings.autoCheckoutTime} if they forgot to check out`,
                                            },
                                        ].map((item) => (
                                            <div
                                                key={item.key}
                                            ...
                                            >
                                                ...
                                                <Toggle
                                                    value={
                                                        attendanceSettings[
                                                            item.key as keyof typeof attendanceSettings
                                                        ] as boolean
                                                    }
                                                    onChange={(v) =>
                                                        setAttendanceSettings(
                                        ...
                                        {attendanceSettings.autoCheckout && (
                                            ...
                                            >
                                                ...
                                                <input
                                                    type="time"
                                                    value={
                                                        attendanceSettings.autoCheckoutTime
                                                    }
                                                    onChange={(e) =>
                                                        setAttendanceSettings(
                                                            (s: any) => ({
                                    ...
                                    {[
                                        {
                                            ...
                                            desc: "Notify when a biometric device goes offline",
                                            category: "Device",
                                        },
                                        {
                                            key: "deviceOnline",
                                            label: "Device Online Alert",
                                            desc: "Notify when an offline device comes back online",
                                            category: "Device",
                                        },
                                        {
                                            key: "lateArrival",
                                            label: "Late Arrival Alert",
                                            desc: "Notify when employees arrive late",
                                            category: "Attendance",
                                        },
                                        {
                                            key: "earlyLeave",
                                            label: "Early Leave Alert",
                                            desc: "Notify when employees leave before end of shift",
                                            category: "Attendance",
                                        },
                                        {
                                            key: "consecutiveAbsence",
                                            label: "Consecutive Absence Alert",
                                            desc: "Notify when employees are absent for multiple consecutive days",
                                            category: "Attendance",
                                        },
                                        {
                                            key: "syncComplete",
                                            label: "Sync Complete",
                                            desc: "Notify when device data sync completes successfully",
                                            category: "System",
                                        },
                                        {
                                            key: "syncFailed",
                                            label: "Sync Failed Alert",
                                            desc: "Notify when device sync fails",
                                            category: "System",
                                        },
                                        {
                                            key: "biometricEnrollment",
                                            label: "Biometric Enrollment Pending",
                                            desc: "Notify when employees have no biometric data enrolled",
                                            category: "Biometric",
                                        },
                                    ].map((n) => (
                                        <div
                                        ...
                                        >
                                            <div className="flex-1 pr-4">
                                                ...
                                                {n.key ===
                                                    "consecutiveAbsence" &&
                                                    notifSettings.consecutiveAbsence && (
                                                        <div className="mt-2 flex items-center gap-2">
                                                            ...
                                                            <input
                                                                type="number"
                                                                value={
                                                                    notifSettings.consecutiveAbsenceThreshold
                                                                }
                                                                onChange={(e) =>
                                                                    setNotifSettings(
                                                                        (
                                                                ...
                                                                className="w-16 px-2 py-1 rounded text-xs outline-none text-center focus:ring-2 focus:ring-green-500/20"
                                                                style={{
                                                                    background:
                                                                        inputBg,
                                                                    border: `1px solid ${border}`,
                                            ...
                                            <Toggle
                                                value={
                                                    notifSettings[
                                                        n.key as keyof typeof notifSettings
                                                    ] as boolean
                                                }
                                                onChange={(v) =>
                                                    setNotifSettings(
                                        ...
                                        {[
                                            {
                                                ...
                                                desc: "Send daily attendance summary email",
                                            },
                                            {
                                                key: "weeklyReport",
                                                label: "Weekly Summary Report",
                                                desc: "Send weekly attendance summary every Monday",
                                            },
                                            {
                                                key: "emailAlerts",
                                                label: "Email Alerts",
                                                desc: "Send alert notifications via email",
                                            },
                                        ].map((item) => (
                                            <div key={item.key}>
                                                <div
                            ...
                            >
                                ...
                                <div className="flex flex-col gap-4 max-w-sm">
                                    ...
                                    <button
                                        ...
                                        className="w-fit px-5 py-2 text-sm rounded-lg cursor-pointer whitespace-nowrap font-semibold text-white transition-colors hover:opacity-90"
