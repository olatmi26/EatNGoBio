...
interface Props {
    ...
    onTabChange?: (tab: "assignments") => void;
}
...
export default function AutoAssignModal({
    ...
    const includedEmployees = matchedEmployees.filter(
        (e) => !excludedIds.has(String(e.id)),
    );
    ...
    // Safe helper for initials
    const getInitials = (emp: EmployeePreview): string => {
    ...
    const getFullName = (emp: EmployeePreview): string => {
        const name = `${emp.firstName || ""} ${emp.lastName || ""}`.trim();
        return name || emp.employeeId || "Unknown";
    };

    // Group matched employees by area
    const byArea = matchedEmployees.reduce<Record<string, EmployeePreview[]>>(
        (acc, e) => {
            ...
            >
                ...
                >
                    <div className="flex items-center gap-3">
                        ...
                        >
                            <i
                                className="ri-flashlight-line text-base"
                ...
                <div className="flex-1 overflow-y-auto">
                    ...
                    <div
                        className="mx-6 mt-5 p-4 rounded-xl flex items-center gap-4"
                        style={{
                            background: `${shift.color}12`,
                        ...
                        <div className="flex-1 grid grid-cols-3 gap-3">
                            ...
                            <div>
                                ...
                                <p
                                    ...
                                    style={{ color: textPrimary }}
                                >
                                    {shift.locations?.length || 0} area
                                    {shift.locations?.length !== 1 ? "s" : ""}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        >
                            <div>
                                ...
                                <p
                                    ...
                                    style={{ color: textSecondary }}
                                >
                                    Previous open assignments for these
                                    employees will be closed the day before the
                                    effective date
                                </p>
                            </div>
                            <div
                    ...
                    <div className="px-6 mt-5 mb-5">
                        <div className="flex items-center justify-between mb-3">
                            <div>
                                ...
                                <p
                                    ...
                                    style={{ color: textSecondary }}
                                >
                                    {includedEmployees.length} of{" "}
                                    {matchedEmployees.length} employees will be
                                    assigned
                                    {excludedIds.size > 0 && (
                        ...
                        {matchedEmployees.length === 0 ? (
                            ...
                            >
                                <i
                                    className="ri-user-unfollow-line text-3xl mb-2 block"
                                    style={{ color: textSecondary }}
                                ></i>
                                <p
                                ...
                                <p
                                    ...
                                    style={{ color: textSecondary }}
                                >
                                    None of the active employees are in{" "}
                                    {shift.locations?.join(", ") ||
                                ...
                                {Object.entries(byArea).map(
                                    ([area, emps], aIdx) => (
                                        <div key={area}>
                                            ...
                                            >
                                                <i
                                                    className="ri-map-pin-2-line text-xs"
                                                    style={{ color: "#16a34a" }}
                                                ></i>
                                                <span
                                                    className="text-xs font-semibold"
                        ...
                        >
                            {loading ? (
                                ...
                                <>
                                    ...
                                    Auto-Assign ({includedEmployees.length})
                                </>
                            )}
                        </button>
                    </div>
