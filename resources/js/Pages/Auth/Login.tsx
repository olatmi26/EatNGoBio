    ...
    const features = [
        {
            ...
            desc: "Multi-layer biometric auth with liveness detection & anti-spoofing.",
            color: "#34d399",
        ...
        },
        {
            ...
            desc: "Sub-second attendance propagation across all connected terminals.",
            color: "#38bdf8",
        ...
        },
        {
            ...
            desc: "Unlimited branch control with geo-fenced policy enforcement.",
            color: "#a78bfa",
        ...
        },
        {
            ...
            desc: "Payroll-ready analytics, shift patterns & exception flagging.",
            color: "#fbbf24",
    ...
    return (
        <>
            ...
            <div className="lr-root">
                {/* ── Unified background layers (span entire viewport, ignore panel split) ── */}
                <div className={`lr-base ${d ? "dk" : "lt"}`} />
                <div className={`aurora ${d ? "dk" : "lt"}`} />

                {/* Traversing orbs */}
                <div className="orb-layer">
                    <div className={`orb orb-traverse-1 ${d ? "dk" : "lt"}`} />
                    <div className={`orb orb-traverse-2 ${d ? "dk" : "lt"}`} />
                    <div className={`orb orb-traverse-3 ${d ? "dk" : "lt"}`} />
                </div>
                ...
                <div className="bubble-layer">
                    {[
                        ...
                        <div
                            key={b}
                            className={`bubble ${b} ${d ? "dk" : "lt"}`}
                        />
                    ))}
                </div>

                <div className="gloss-sheen" />
                <div className={`lr-dots ${d ? "" : "lt"}`} />

                {/* ── Content panels (transparent — background shows through both) ── */}
                <div className="lr-panels">
                    {/* ════ LEFT PANEL ════ */}
                    <div className={`lr-left ${d ? "dk" : "lt"}`}>
                        <div className="tb">
                            <div className="logo">
                            ...
                            <button
                                className={`theme-btn ${d ? "dk" : "lt"}`}
                                onClick={toggleTheme}
                            >
                                <i
                                    className={
                                        d ? "ri-sun-line" : "ri-moon-line"
                                    }
                                />
                            </button>
                        </div>

                        <div className={`pill ${d ? "dk" : "lt"}`}>
                        ...
                        >
                            ...
                            <br />
                            <span className="gr">Built for Scale</span>
                        </h1>

                        <p
                            className="hero-sub"
                            style={{ color: d ? "#64748b" : "#4b5563" }}
                        >
                            Self-hosted biometric attendance with unlimited
                            terminals, real-time sync, and enterprise policy
                            controls — no seat limits, no third-party licensing.
                        </p>
                        ...
                        <div className="lr-lfooter">
                            ...
                            <span
                                className="lf-text"
                                style={{ color: d ? "#334155" : "#94a3b8" }}
                            >
                                EatNGo Africa · All Rights Reserved
                            </span>
                            <div
                                className="lf-line"
                                style={{
                    ...
                    <div className="lr-right">
                        <div className="form-shell">
                            ...
                            <div className={`glass ${d ? "dk" : "lt"}`}>
                                <p className="card-eye">— Secure Portal</p>
                                <h2
                                ...
                                <form onSubmit={submit}>
                                    <div className="field">
                                        ...
                                        <div className="field-wrap">
                                            <i
                                                className={`ri-mail-line f-icon ${d ? "dk" : "lt"}`}
                                            />
                                            <input
                                                type="email"
                                                value={data.email}
                                                ...
                                                className={`f-input ${d ? "dk" : "lt"} ${errors.email ? "err" : ""}`}
                                                required
                                            />
                                        </div>
                                        {errors.email && (
                                    ...
                                    <div className="field">
                                        ...
                                        <div className="field-wrap">
                                            <i
                                                className={`ri-lock-2-line f-icon ${d ? "dk" : "lt"}`}
                                            />
                                            <input
                                                type="password"
                                                value={data.password}
                                                ...
                                                placeholder="••••••••••••"
                                                className={`f-input ${d ? "dk" : "lt"} ${errors.password ? "err" : ""}`}
                                                required
                                            />
                                        </div>
                                        {errors.password && (
                                ...
                                <div className="trust-row">
                                    {[
                                        ...
                                        <div
                                            key={t.label}
                                            className={`trust-item ${i > 0 ? (d ? "dk-sep" : "lt-sep") : ""}`}
                                            style={{
                                                color: d
                                                    ? "#94a3b8"
                                                    : "#6b7280",
                            ...
                            <p
                                ...
                                style={{ color: d ? "#475569" : "#9ca3af" }}
                            >
                                EatNGo Biometrics — Enterprise Attendance
                                Platform
                            </p>
                        </div>
                    </div>
