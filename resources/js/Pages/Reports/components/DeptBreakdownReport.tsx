...
interface Props {
    ...
    allDepartments?: string[]; // Add this to show all departments
}

export default function DeptBreakdownReport({
    data,
    allDepartments = [],
}: Props) {
    ...
    // Ensure all departments from props.allDepartments are included
                    ...
                    >
                        ...
                        >
                            <div
                                ...
                                style={{
                                    width: `${(d.avgRate / maxRate) * 100}%`,
                                    background: rateColor(d.avgRate),
                                }}
                            ></div>
                        </div>
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3">
                                            <span
                                                ...
                                                style={{
                                                    background: `${rateColor(d.avgRate)}20`,
                                                    color: rateColor(d.avgRate),
                                                }}
                                            >
                                                {d.avgRate.toFixed(1)}%
                                            </span>
                                        ...
                                        >
                                            {d.totalOT.toFixed(1)}h
                                        </td>
                                    </tr>
                                ))}
                            {deptStats.filter((d) => d.count > 0).length ===
                                0 && (
                                <tr>
                                    <td
                                        colSpan={8}
